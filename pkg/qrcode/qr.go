...
var errorCorrectionTable = []map[ECLevel][]int{
	...
	{
		ECLevelL: {7, 1, 19, 0, 0},
		ECLevelM: {10, 1, 16, 0, 0},
		ECLevelQ: {13, 1, 13, 0, 0},
		ECLevelH: {17, 1, 9, 0, 0},
	}, // version 1
	{
		ECLevelL: {10, 1, 34, 0, 0},
		ECLevelM: {16, 1, 28, 0, 0},
		ECLevelQ: {22, 1, 22, 0, 0},
		ECLevelH: {28, 1, 16, 0, 0},
	},
	{
		ECLevelL: {15, 1, 55, 0, 0},
		ECLevelM: {26, 1, 44, 0, 0},
		ECLevelQ: {18, 2, 17, 0, 0},
		ECLevelH: {22, 2, 13, 0, 0},
	},
	{
		ECLevelL: {20, 1, 80, 0, 0},
		ECLevelM: {18, 2, 32, 0, 0},
		ECLevelQ: {26, 2, 24, 0, 0},
		ECLevelH: {16, 4, 9, 0, 0},
	},
	{
		ECLevelL: {26, 1, 108, 0, 0},
		ECLevelM: {24, 2, 43, 0, 0},
		ECLevelQ: {18, 2, 15, 2, 16},
		ECLevelH: {22, 2, 11, 2, 12},
	}, // version 5
	{
		ECLevelL: {18, 2, 68, 0, 0},
		ECLevelM: {16, 4, 27, 0, 0},
		ECLevelQ: {24, 4, 19, 0, 0},
		ECLevelH: {28, 4, 15, 0, 0},
	},
	{
		ECLevelL: {20, 2, 78, 0, 0},
		ECLevelM: {18, 4, 31, 0, 0},
		ECLevelQ: {18, 2, 14, 4, 15},
		ECLevelH: {26, 4, 13, 1, 14},
	},
	{
		ECLevelL: {24, 2, 97, 0, 0},
		ECLevelM: {22, 2, 38, 2, 39},
		ECLevelQ: {22, 4, 18, 2, 19},
		ECLevelH: {26, 4, 14, 2, 15},
	},
	{
		ECLevelL: {30, 2, 116, 0, 0},
		ECLevelM: {22, 3, 36, 2, 37},
		ECLevelQ: {20, 4, 16, 4, 17},
		ECLevelH: {24, 4, 12, 4, 13},
	},
	{
		ECLevelL: {18, 2, 68, 2, 69},
		ECLevelM: {26, 4, 43, 1, 44},
		ECLevelQ: {24, 6, 19, 2, 20},
		ECLevelH: {28, 6, 15, 2, 16},
	}, // version 10
	{
		ECLevelL: {20, 4, 81, 0, 0},
		ECLevelM: {31, 1, 50, 4, 51},
		ECLevelQ: {28, 4, 22, 4, 23},
		ECLevelH: {24, 3, 12, 8, 13},
	},
	{
		ECLevelL: {24, 2, 92, 2, 93},
		ECLevelM: {22, 6, 36, 2, 37},
		ECLevelQ: {26, 4, 20, 6, 21},
		ECLevelH: {28, 7, 14, 4, 15},
	},
	{
		ECLevelL: {26, 4, 107, 0, 0},
		ECLevelM: {22, 8, 37, 1, 38},
		ECLevelQ: {24, 8, 20, 4, 21},
		ECLevelH: {22, 12, 11, 4, 12},
	},
	{
		ECLevelL: {30, 3, 115, 1, 116},
		ECLevelM: {24, 4, 40, 5, 41},
		ECLevelQ: {20, 11, 16, 5, 17},
		ECLevelH: {24, 11, 12, 5, 13},
	},
	{
		ECLevelL: {22, 5, 87, 1, 88},
		ECLevelM: {24, 5, 41, 5, 42},
		ECLevelQ: {30, 5, 24, 7, 25},
		ECLevelH: {30, 5, 24, 7, 25},
	},
	{
		ECLevelL: {24, 5, 98, 1, 99},
		ECLevelM: {28, 7, 45, 3, 46},
		ECLevelQ: {24, 15, 19, 2, 20},
		ECLevelH: {30, 3, 15, 13, 16},
	},
	{
		ECLevelL: {28, 1, 107, 5, 108},
		ECLevelM: {28, 10, 46, 1, 47},
		ECLevelQ: {28, 1, 22, 15, 23},
		ECLevelH: {28, 2, 14, 17, 15},
	},
	{
		ECLevelL: {30, 5, 120, 1, 121},
		ECLevelM: {26, 9, 43, 4, 44},
		ECLevelQ: {28, 17, 22, 1, 23},
		ECLevelH: {28, 2, 14, 19, 15},
	},
	{
		ECLevelL: {28, 3, 113, 4, 114},
		ECLevelM: {26, 3, 44, 11, 45},
		ECLevelQ: {26, 17, 21, 4, 22},
		ECLevelH: {26, 9, 13, 16, 14},
	},
	{
		ECLevelL: {28, 3, 107, 6, 108},
		ECLevelM: {26, 3, 41, 13, 42},
		ECLevelQ: {30, 15, 24, 5, 25},
		ECLevelH: {28, 15, 15, 10, 16},
	}, // version 20
	{
		ECLevelL: {28, 4, 116, 4, 117},
		ECLevelM: {26, 17, 42, 0, 0},
		ECLevelQ: {28, 17, 22, 6, 23},
		ECLevelH: {30, 19, 16, 6, 17},
	},
	{
		ECLevelL: {28, 2, 111, 7, 112},
		ECLevelM: {28, 17, 46, 0, 0},
		ECLevelQ: {30, 7, 24, 16, 25},
		ECLevelH: {24, 34, 13, 0, 0},
	},
	{
		ECLevelL: {30, 4, 121, 5, 122},
		ECLevelM: {28, 4, 47, 14, 48},
		ECLevelQ: {30, 11, 24, 14, 25},
		ECLevelH: {30, 16, 15, 14, 16},
	},
	{
		ECLevelL: {30, 6, 117, 4, 118},
		ECLevelM: {28, 6, 45, 14, 46},
		ECLevelQ: {30, 11, 24, 16, 25},
		ECLevelH: {30, 30, 16, 2, 17},
	},
	{
		ECLevelL: {26, 8, 106, 4, 107},
		ECLevelM: {28, 8, 47, 13, 48},
		ECLevelQ: {230, 7, 24, 22, 25},
		ECLevelH: {30, 22, 15, 13, 16},
	},
	{
		ECLevelL: {28, 10, 114, 2, 115},
		ECLevelM: {28, 19, 46, 4, 47},
		ECLevelQ: {28, 28, 22, 6, 23},
		ECLevelH: {30, 33, 16, 4, 17},
	},
	{
		ECLevelL: {30, 8, 122, 4, 123},
		ECLevelM: {28, 22, 45, 3, 46},
		ECLevelQ: {30, 8, 23, 26, 24},
		ECLevelH: {30, 12, 15, 28, 16},
	},
	{
		ECLevelL: {30, 3, 117, 10, 118},
		ECLevelM: {28, 3, 45, 23, 46},
		ECLevelQ: {30, 4, 24, 31, 25},
		ECLevelH: {30, 11, 15, 31, 16},
	},
	{
		ECLevelL: {30, 7, 116, 7, 117},
		ECLevelM: {28, 21, 45, 7, 46},
		ECLevelQ: {30, 1, 23, 37, 24},
		ECLevelH: {30, 19, 15, 26, 16},
	},
	{
		ECLevelL: {30, 5, 115, 10, 116},
		ECLevelM: {28, 19, 47, 10, 48},
		ECLevelQ: {30, 15, 24, 25, 25},
		ECLevelH: {30, 23, 15, 25, 16},
	}, // version 30
	{
		ECLevelL: {30, 13, 115, 3, 116},
		ECLevelM: {28, 2, 46, 29, 47},
		ECLevelQ: {30, 42, 24, 1, 25},
		ECLevelH: {30, 23, 15, 28, 16},
	},
	{
		ECLevelL: {30, 17, 115, 0, 0},
		ECLevelM: {28, 10, 46, 23, 47},
		ECLevelQ: {30, 10, 24, 35, 25},
		ECLevelH: {30, 19, 15, 35, 16},
	},
	{
		ECLevelL: {30, 17, 115, 1, 116},
		ECLevelM: {28, 14, 46, 21, 47},
		ECLevelQ: {30, 29, 24, 19, 25},
		ECLevelH: {30, 11, 15, 46, 16},
	},
	{
		ECLevelL: {30, 13, 115, 6, 116},
		ECLevelM: {28, 14, 46, 13, 47},
		ECLevelQ: {30, 44, 24, 7, 25},
		ECLevelH: {30, 59, 16, 1, 17},
	},
	{
		ECLevelL: {30, 12, 121, 7, 122},
		ECLevelM: {28, 12, 47, 26, 48},
		ECLevelQ: {30, 39, 24, 14, 25},
		ECLevelH: {30, 22, 15, 41, 16},
	},
	{
		ECLevelL: {30, 6, 121, 14, 122},
		ECLevelM: {28, 6, 47, 34, 48},
		ECLevelQ: {30, 46, 24, 10, 25},
		ECLevelH: {30, 2, 15, 64, 16},
	},
	{
		ECLevelL: {30, 17, 122, 4, 123},
		ECLevelM: {28, 29, 46, 14, 47},
		ECLevelQ: {30, 49, 24, 10, 25},
		ECLevelH: {30, 24, 15, 46, 16},
	},
	{
		ECLevelL: {30, 4, 122, 18, 123},
		ECLevelM: {28, 13, 46, 32, 47},
		ECLevelQ: {30, 48, 24, 14, 25},
		ECLevelH: {30, 42, 15, 32, 16},
	},
	{
		ECLevelL: {30, 20, 117, 4, 118},
		ECLevelM: {28, 40, 47, 7, 48},
		ECLevelQ: {30, 43, 24, 22, 25},
		ECLevelH: {30, 10, 15, 67, 16},
	},
	{
		ECLevelL: {30, 19, 118, 6, 119},
		ECLevelM: {28, 18, 47, 31, 48},
		ECLevelQ: {30, 34, 24, 34, 25},
		ECLevelH: {30, 20, 15, 61, 16},
	}, // version 40
}
...
func (qr *Qrcode) dataCodeWords() []int {
	return []int{
		qr.table()[2],
		qr.table()[4],
	}
}
func (qr *Qrcode) blkCount() []int {
	return []int{
		qr.table()[1],
		qr.table()[3],
	}
...
func (qr *Qrcode) errorCorrectionCode(
	data []byte,
	block, blockIndex int,
	c chan int,
) {
...
func (qr *Qrcode) encodeData() {
	...
	for i, k := 0, 0; i < 2; i++ { // rs block 1, 2
		for j := 0; j < qr.blkCount()[i]; j, k = j+1, k+1 {
			go qr.errorCorrectionCode(
				bytebuf.Next(qr.dataCodeWords()[i]),
				i,
				k,
				c,
			)
