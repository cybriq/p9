...
func TestIPTypes(t *testing.T) {
	...
	newIPTest := func(ip string, rfc1918, rfc2544, rfc3849, rfc3927, rfc3964,
		...
		test := ipTest{na, rfc1918, rfc2544, rfc3849, rfc3927, rfc3964, rfc4193,
			rfc4380,
	...
	tests := []ipTest{
		...
		newIPTest("172.32.1.1", false, false, false, false, false, false, false,
			false,
		...
		newIPTest("100.127.255.1", false, false, false, false, false, false,
			false,
			false, false, false, false, false, true, false, true, false,
		),
		newIPTest("203.0.113.1", false, false, false, false, false, false,
			false,
			false, false, false, false, false, false, false, true, false,
		),
	}
