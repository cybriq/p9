...
var OpcodeArray = [256]opcode{
	...
	OP_NUMEQUALVERIFY: {
		OP_NUMEQUALVERIFY, "OP_NUMEQUALVERIFY", 1,
		opcodeNumEqualVerify,
	},
	OP_NUMNOTEQUAL: {
		OP_NUMNOTEQUAL, "OP_NUMNOTEQUAL", 1,
		opcodeNumNotEqual,
	},
	OP_LESSTHAN: {OP_LESSTHAN, "OP_LESSTHAN", 1, opcodeLessThan},
	OP_GREATERTHAN: {
		OP_GREATERTHAN, "OP_GREATERTHAN", 1,
		opcodeGreaterThan,
	},
	OP_LESSTHANOREQUAL: {
		OP_LESSTHANOREQUAL, "OP_LESSTHANOREQUAL", 1,
		opcodeLessThanOrEqual,
	},
	OP_GREATERTHANOREQUAL: {
		OP_GREATERTHANOREQUAL, "OP_GREATERTHANOREQUAL", 1,
	...
	OP_CODESEPARATOR: {
		OP_CODESEPARATOR, "OP_CODESEPARATOR", 1,
		opcodeCodeSeparator,
	},
	OP_CHECKSIG: {OP_CHECKSIG, "OP_CHECKSIG", 1, opcodeCheckSig},
	OP_CHECKSIGVERIFY: {
		OP_CHECKSIGVERIFY, "OP_CHECKSIGVERIFY", 1,
		opcodeCheckSigVerify,
	},
	OP_CHECKMULTISIG: {
		OP_CHECKMULTISIG, "OP_CHECKMULTISIG", 1,
		opcodeCheckMultiSig,
	},
	OP_CHECKMULTISIGVERIFY: {
		OP_CHECKMULTISIGVERIFY, "OP_CHECKMULTISIGVERIFY",
		1, opcodeCheckMultiSigVerify,
	},
	// Reserved opcodes.
