...
func WriteMessageN(
	w io.Writer, msg Message, pver uint32, btcnet BitcoinNet,
) (int, error) {
...
func ReadMessageN(r io.Reader, pver uint32, btcnet BitcoinNet) (
	int, Message,
	[]byte, error,
) {
...
func ReadMessage(r io.Reader, pver uint32, btcnet BitcoinNet) (
	msg Message,
	buf []byte, e error,
) {
