...
// maxAlertSize = fixedAlertSize + max(SetCancel) + max(SetSubVer) + 3*(string) for caculating maximum number of cancel IDs, set all other var  txsizes to 0
...
// for caculating maximum number of subversions, set all other var txsizes to 0
